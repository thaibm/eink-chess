...
(function (root) {
    ...
    var translations = {
        vi: {
            ...
            'home.bot_card_desc': 'Tập luyện với Bot v1 (Minimax offline) hoặc Bot v2 (Tomitank 7.0 siêu cấp). Tính điểm ELO sau mỗi ván đấu.',
        ...
        en: {
            ...
            'home.bot_card_desc': 'Practice chess against Bot v1 (Offline Minimax) or Bot v2 (Advanced Tomitank 7.0). Track ELO rating after each match.',
